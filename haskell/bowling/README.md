...
* `roll :: Bowling -> Int -> Bowling` is called each time the player rolls a ball.  The
  second argument is the number of pins knocked down.
* `score :: Bowling -> Maybe Int` is called only at the very end of the game.  It
