...
class SayTest extends FunSuite with Matchers {
  ...
  test("one hundred two") {
    Say.inEnglish(102) should be (Some("one hundred two"))
  }

  test("one hundred eleven") {
    Say.inEnglish(111) should be (Some("one hundred eleven"))
  }
  ...
  test("eleven thousand two hundred thirty-four") {
    Say.inEnglish(11234) should be (Some("eleven thousand two hundred thirty-four"))
  }

  test("one hundred eleven thousand two hundred thirty-four") {
    Say.inEnglish(111234) should be (Some("one hundred eleven thousand two hundred thirty-four"))
  }

  test("nine hundred ninety-nine thousand nine hundred ninety-nine") {
    Say.inEnglish(999999) should be (Some("nine hundred ninety-nine thousand nine hundred ninety-nine"))
  }
  ...
  test("nine hundred ninety-nine million nine hundred ninety-nine thousand nine hundred ninety-nine") {
    Say.inEnglish(999999999) should be (Some("nine hundred ninety-nine million nine hundred ninety-nine thousand nine hundred ninety-nine"))
  }
